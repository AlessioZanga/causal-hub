...
use crate::{
    data::{DiscreteDataSet, JointConditionalCountMatrix, JointCountMatrix},
...
impl<'a> ChiSquared<'a> {
    ...
    #[inline]
    pub const fn new(d: &'a DiscreteDataSet) -> Self {
        Self { d, alpha: 0.05 }
    }
}

impl<'a> From<&'a DiscreteDataSet> for ChiSquared<'a> {
    #[inline]
    fn from(d: &'a DiscreteDataSet) -> Self {
        Self::new(d)
    }
}
