...
use super::{DataSet, DiscreteDataSet, RavelMultiIndex};
...
impl MarginalCountMatrix {
    ...
    #[inline]
    pub fn new(d: &DiscreteDataSet, x: usize) -> Self {
        // Get cardinalities.
...
impl<const PARALLEL: bool> ConditionalCountMatrix<PARALLEL> {
    ...
    /// Build new count matrix with given data matrix and indices.
    #[inline]
    pub fn new(d: &DiscreteDataSet, x: usize, z: &[usize]) -> Self {
        // Get cardinalities.
        let cards = d.cardinality();
        ...
        let n = match PARALLEL {
            ...
            false => Self::eval(shape, &rmi, d.data().view(), x, z),
        };
...
impl JointCountMatrix {
    /// Build new count matrix with given data matrix and indices.
    #[inline]
    pub fn new(d: &DiscreteDataSet, x: usize, y: usize) -> Self {
        // Get cardinalities.
        let cards = d.cardinality();
...
impl JointConditionalCountMatrix {
    /// Build new count matrix with given data matrix and indices.
    #[inline]
    pub fn new(d: &DiscreteDataSet, x: usize, y: usize, z: &[usize]) -> Self {
        // Get cardinalities.
        let cards = d.cardinality();
