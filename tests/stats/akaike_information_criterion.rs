...
mod tests {
    ...
    fn akaike_information_criterion() {
        ...
        let data =
            std::fs::read_to_string("./tests/assets/akaike_information_criterion.json").unwrap();
        ...
        let score = AkaikeInformationCriterion::<true, false, false>::new();
    ...
    fn parallel_akaike_information_criterion() {
        ...
        // Initialize the default scoring criterion.
        let score = AkaikeInformationCriterion::<true, true, true>::new();
