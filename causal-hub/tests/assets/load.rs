...
mod tests {
    ...
    fn test_load_eating_json() {
        ...
        assert_eq!(
            json.as_str(),
            r#"{"initial_distribution":{"states":{"Eating":["no","yes"],"FullStomach":["no","yes"],"Hungry":["no","yes"]},"graph":{"labels":["Eating","FullStomach","Hungry"],"adjacency_matrix":{"v":1,"dim":[3,3],"data":[false,false,false,false,false,false,false,false,false]}},"cpds":{"Eating":{"label":"Eating","states":["no","yes"],"cardinality":2,"conditioning_labels":[],"conditioning_states":{},"conditioning_cardinality":{"v":1,"dim":[0],"data":[]},"multi_index":{"cardinality":{"v":1,"dim":[0],"data":[]},"strides":{"v":1,"dim":[0],"data":[]}},"parameters":{"v":1,"dim":[1,2],"data":[0.5,0.5]},"parameters_size":1,"sample_size":null,"sample_log_likelihood":null},"FullStomach":{"label":"FullStomach","states":["no","yes"],"cardinality":2,"conditioning_labels":[],"conditioning_states":{},"conditioning_cardinality":{"v":1,"dim":[0],"data":[]},"multi_index":{"cardinality":{"v":1,"dim":[0],"data":[]},"strides":{"v":1,"dim":[0],"data":[]}},"parameters":{"v":1,"dim":[1,2],"data":[0.5,0.5]},"parameters_size":1,"sample_size":null,"sample_log_likelihood":null},"Hungry":{"label":"Hungry","states":["no","yes"],"cardinality":2,"conditioning_labels":[],"conditioning_states":{},"conditioning_cardinality":{"v":1,"dim":[0],"data":[]},"multi_index":{"cardinality":{"v":1,"dim":[0],"data":[]},"strides":{"v":1,"dim":[0],"data":[]}},"parameters":{"v":1,"dim":[1,2],"data":[0.5,0.5]},"parameters_size":1,"sample_size":null,"sample_log_likelihood":null}},"topological_order":[0,1,2]},"graph":{"labels":["Eating","FullStomach","Hungry"],"adjacency_matrix":{"v":1,"dim":[3,3],"data":[false,true,false,false,false,true,true,false,false]}},"cims":{"Eating":{"label":"Eating","states":["no","yes"],"cardinality":2,"conditioning_labels":["Hungry"],"conditioning_states":{"Hungry":["no","yes"]},"conditioning_cardinality":{"v":1,"dim":[1],"data":[2]},"multi_index":{"cardinality":{"v":1,"dim":[1],"data":[2]},"strides":{"v":1,"dim":[1],"data":[1]}},"parameters":{"v":1,"dim":[2,2,2],"data":[-0.1,0.1,10.0,-10.0,-2.0,2.0,0.1,-0.1]},"parameters_size":4,"sample_size":null,"sample_log_likelihood":null},"FullStomach":{"label":"FullStomach","states":["no","yes"],"cardinality":2,"conditioning_labels":["Eating"],"conditioning_states":{"Eating":["no","yes"]},"conditioning_cardinality":{"v":1,"dim":[1],"data":[2]},"multi_index":{"cardinality":{"v":1,"dim":[1],"data":[2]},"strides":{"v":1,"dim":[1],"data":[1]}},"parameters":{"v":1,"dim":[2,2,2],"data":[-0.1,0.1,10.0,-10.0,-2.0,2.0,0.1,-0.1]},"parameters_size":4,"sample_size":null,"sample_log_likelihood":null},"Hungry":{"label":"Hungry","states":["no","yes"],"cardinality":2,"conditioning_labels":["FullStomach"],"conditioning_states":{"FullStomach":["no","yes"]},"conditioning_cardinality":{"v":1,"dim":[1],"data":[2]},"multi_index":{"cardinality":{"v":1,"dim":[1],"data":[2]},"strides":{"v":1,"dim":[1],"data":[1]}},"parameters":{"v":1,"dim":[2,2,2],"data":[-0.1,0.1,10.0,-10.0,-2.0,2.0,0.1,-0.1]},"parameters_size":4,"sample_size":null,"sample_log_likelihood":null}}}"#
        );
    }
}
