...
mod tests {
    mod digraph {
        ...
        fn is_backdoor_set_out_of_bounds_x() {
            ...
            let _ = g.is_backdoor_set(&set![5], &set![1], &set![]);
        }
        ...
        fn is_backdoor_set_out_of_bounds_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_backdoor_set(&set![0], &set![5], &set![]);
        }
        ...
        fn is_backdoor_set_out_of_bounds_z() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_backdoor_set(&set![0], &set![1], &set![5]);
        }
        ...
        fn is_backdoor_set_empty_x() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_backdoor_set(&set![], &set![1], &set![]);
        }
        ...
        fn is_backdoor_set_empty_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_backdoor_set(&set![0], &set![], &set![]);
        }
        ...
        fn is_backdoor_set_non_disjoint_x_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_backdoor_set(&set![0], &set![0], &set![]);
        }
        ...
        fn is_backdoor_set_non_disjoint_x_z() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_backdoor_set(&set![0], &set![1], &set![0]);
        }
        ...
        fn is_backdoor_set_non_disjoint_y_z() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_backdoor_set(&set![0], &set![1], &set![1]);
        }
        ...
        fn is_backdoor_set_edge() {
            ...
            assert_eq!(g.is_backdoor_set(&set![0], &set![1], &set![]), Ok(true));
            assert_eq!(g.is_backdoor_set(&set![1], &set![0], &set![]), Ok(false));
            ...
            assert_eq!(g.is_backdoor_set(&set![0], &set![1], &set![]), Ok(true));
            assert_eq!(g.is_backdoor_set(&set![1], &set![0], &set![]), Ok(true));
        }
        ...
        fn is_backdoor_set_chain() {
            ...
            // Test for backdoor criterion.
            assert_eq!(g.is_backdoor_set(&set![0], &set![2], &set![]), Ok(true));
            assert_eq!(g.is_backdoor_set(&set![2], &set![0], &set![1]), Ok(true));
        }
        ...
        fn is_backdoor_set_fork() {
            ...
            // Test for backdoor criterion.
            assert_eq!(g.is_backdoor_set(&set![1], &set![2], &set![]), Ok(false));
            assert_eq!(g.is_backdoor_set(&set![2], &set![1], &set![]), Ok(false));
            assert_eq!(g.is_backdoor_set(&set![1], &set![2], &set![0]), Ok(true));
            assert_eq!(g.is_backdoor_set(&set![2], &set![1], &set![0]), Ok(true));
        }
        ...
        fn is_backdoor_set_collider() {
            ...
            // Test for backdoor criterion.
            assert_eq!(g.is_backdoor_set(&set![1], &set![2], &set![]), Ok(true));
            assert_eq!(g.is_backdoor_set(&set![2], &set![1], &set![]), Ok(true));
        }
        ...
        fn is_backdoor_set_primer_figure_3_7() {
            ...
            assert_eq!(g.is_backdoor_set(&set![2], &set![3], &set![]), Ok(false));
            assert_eq!(g.is_backdoor_set(&set![2], &set![3], &set![4]), Ok(false));
            assert_eq!(g.is_backdoor_set(&set![2], &set![3], &set![0, 4]), Ok(true));
            assert_eq!(g.is_backdoor_set(&set![2], &set![3], &set![1, 4]), Ok(true));
            assert_eq!(
        ...
        fn is_minimal_backdoor_set_out_of_bounds_x() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![5], &set![1], &set![], None, None);
        }
        ...
        fn is_minimal_backdoor_set_out_of_bounds_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![0], &set![5], &set![], None, None);
        }
        ...
        fn is_minimal_backdoor_set_out_of_bounds_z() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![0], &set![1], &set![5], None, None);
        }
        ...
        fn is_minimal_backdoor_set_empty_x() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![], &set![1], &set![], None, None);
        }
        ...
        fn is_minimal_backdoor_set_empty_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![0], &set![], &set![], None, None);
        }
        ...
        fn is_minimal_backdoor_set_non_disjoint_x_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![0], &set![0], &set![], None, None);
        }
        ...
        fn is_minimal_backdoor_set_non_disjoint_x_z() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![0], &set![1], &set![0], None, None);
        }
        ...
        fn is_minimal_backdoor_set_non_disjoint_y_z() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.is_minimal_backdoor_set(&set![0], &set![1], &set![1], None, None);
        }
        ...
        fn find_minimal_backdoor_set_out_of_bounds_x() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.find_minimal_backdoor_set(&set![5], &set![1], None, None);
        }
        ...
        fn find_minimal_backdoor_set_out_of_bounds_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.find_minimal_backdoor_set(&set![0], &set![5], None, None);
        }
        ...
        fn find_minimal_backdoor_set_empty_x() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.find_minimal_backdoor_set(&set![], &set![1], None, None);
        }
        ...
        fn find_minimal_backdoor_set_empty_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.find_minimal_backdoor_set(&set![0], &set![], None, None);
        }
        ...
        fn find_minimal_backdoor_set_non_disjoint_x_y() {
            let g = DiGraph::empty(["A", "B", "C"]);
            let _ = g.find_minimal_backdoor_set(&set![0], &set![0], None, None);
        }
