...
# Pass through environment variables for CMAKE_*_COMPILER_LAUNCHER for C, C++ and Fortran.
set(CMAKE_C_COMPILER_LAUNCHER "$ENV{CMAKE_C_COMPILER_LAUNCHER}")
if(NOT "${CMAKE_C_COMPILER_LAUNCHER}" STREQUAL "")
    message(STATUS "CMAKE_C_COMPILER_LAUNCHER: ${CMAKE_C_COMPILER_LAUNCHER}")
    list(APPEND OPTIONS -DCMAKE_C_COMPILER_LAUNCHER=${CMAKE_C_COMPILER_LAUNCHER})
endif()
set(CMAKE_CXX_COMPILER_LAUNCHER "$ENV{CMAKE_CXX_COMPILER_LAUNCHER}")
if(NOT "${CMAKE_CXX_COMPILER_LAUNCHER}" STREQUAL "")
    message(STATUS "CMAKE_CXX_COMPILER_LAUNCHER: ${CMAKE_CXX_COMPILER_LAUNCHER}")
    list(APPEND OPTIONS -DCMAKE_CXX_COMPILER_LAUNCHER=${CMAKE_CXX_COMPILER_LAUNCHER})
endif()
set(CMAKE_Fortran_COMPILER_LAUNCHER "$ENV{CMAKE_Fortran_COMPILER_LAUNCHER}")
if(NOT "${CMAKE_Fortran_COMPILER_LAUNCHER}" STREQUAL "")
    message(STATUS "CMAKE_Fortran_COMPILER_LAUNCHER: ${CMAKE_Fortran_COMPILER_LAUNCHER}")
